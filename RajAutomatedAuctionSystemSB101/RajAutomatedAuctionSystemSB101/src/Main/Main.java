...
public class Main {
	...
	public static void main(String[] args) {
		...
		case 2:{
			Scanner s=new Scanner(System.in);
			System.out.println("Enter 1:Register for Buyer");
			System.out.println("Enter 2:For buy Products");
			System.out.println("Enter 3:Home Screen");
			int con=s.nextInt();
		...
		case 3:{
			Scanner s=new Scanner(System.in);
			System.out.println("Enter 1:View the registered buyer list");
			System.out.println("Enter 2:View the registered Seller list");
			System.out.println("Enter 3: View the daily dispute report");
			System.out.println("Enter 4:View the daily selling report");
			System.out.println("Enter 5:Solve the dispute report");
			System.out.println("Enter 6:Go back to homescreen");
			int con=s.nextInt();
